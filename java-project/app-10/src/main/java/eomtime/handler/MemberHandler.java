...
public class MemberHandler {
  ...
  public static void addMember() {
    ...
    m.name = Prompt.inputString("이름은?");
    m.age = Prompt.inputInt("나이는?");
    m.local = Prompt.inputBoolean("내국인 여부?");
  ...
  public static void updateMember() {
    ...
    m.name = Prompt.inputString("이름은(%s)? ", m.name);
    m.age = Prompt.inputInt("나이는?(%d) ", m.age);
    m.local = Prompt.inputBoolean("내국인 여부?(%b) ", m.local);
